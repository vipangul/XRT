...
#define AIE_TRACE_NOT_ENABLED                 "No event trace options enabled for application. Please enable runtime event trace by re-compiling AI Engine with --event-trace=runtime."
